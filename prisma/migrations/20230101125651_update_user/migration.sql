...
INSERT INTO "new_User" ("createdAt", "email", "firstName", "id", "lastName", "password", "updateAt", "username") SELECT "createdAt", "email", "firstName", "id", "lastName", "password", "updateAt", "username" FROM "User";
DROP TABLE "User";
