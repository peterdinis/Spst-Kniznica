/*
  ...
  - You are about to alter the column `externalId` on the `User` table. The data in that column could be lost. The data in that column will be cast from `Int` to `BigInt`.
...
CREATE TABLE "new_User" (
    ...
    "externalId" BIGINT NOT NULL DEFAULT 2020,
